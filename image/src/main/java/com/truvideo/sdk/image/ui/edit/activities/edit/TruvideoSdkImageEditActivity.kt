...
import com.truvideo.sdk.image.ui.edit.components.preview.Preview
...
//                }
        ...
        LaunchedEffect(successPath) {
            if (successPath.trim().isNotEmpty()) {
                ...
                setResult(RESULT_OK, Intent().apply { putExtra("resultPath", successPath) })
                finish()
            }
        }
...
//                                    animate = tab != null,
                                    ...
                                    previewPadding = PaddingValues(16.dp)
                                ) {
                                    Box(Modifier.fillMaxSize()) {
                                        androidx.compose.animation.AnimatedVisibility(
